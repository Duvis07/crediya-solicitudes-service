    ...
    public Mono<Void> sendPaymentPlanNotification(
        ...
        return Mono.fromRunnable(() -> {
            try {
                ...
                throw new RuntimeException("Error sending payment plan email", e);
            }
        })
        .doOnSuccess(v -> log.info("Payment plan email processed for: {}", email))
        .doOnError(error -> log.error("Failed to send email to {}: {}", error.getMessage())).then();
    }
    ...
    public Mono<Void> sendRejectionNotification(
        ...
        return Mono.fromRunnable(() -> {
            try {
                ...
                throw new RuntimeException("Error sending rejection email", e);
            }
        });
    }
    ...
    public Mono<Void> sendManualReviewNotification(
        ...
        return Mono.fromRunnable(() -> {
            try {
                ...
                throw new RuntimeException("Error sending manual review email", e);
            }
        });
    }
